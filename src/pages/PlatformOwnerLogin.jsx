...
export default function PlatformOwnerLogin() {
  ...
  const submit = mfaStage ? completeMfa : recoveryMode ? completeRecovery : signIn;
  const pageTitle = mfaStage === 'verify' ? text.mfaTitle : mfaStage === 'enroll' ? text.enrollTitle : recoveryMode ? text.recoveryTitle : text.title;
  const pageIntro = mfaStage === 'verify' ? text.mfaIntro : mfaStage === 'enroll' ? text.enrollIntro : recoveryMode ? text.recoveryIntro : text.intro;
