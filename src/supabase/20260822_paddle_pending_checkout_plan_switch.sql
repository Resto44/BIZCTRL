...
-- A pending Paddle checkout is reusable only for the same plan.  When the
-- owner intentionally selects another plan, supersede the stale pending
-- payment before creating exactly one new canonical pending payment.
