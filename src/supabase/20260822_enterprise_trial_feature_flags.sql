-- Keep feature authorization canonical: valid trials use their assigned plan's
-- configured feature flags. Expiration is still resolved before this payload is
-- constructed, and erp_subscription_has_erp_access remains the access boundary.
BEGIN;
...
BEGIN
  ...
  RETURN jsonb_build_object(
    ...
    'feature_flags', coalesce(v_plan.feature_flags, '[]'::jsonb),
